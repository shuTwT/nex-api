...
import (
	...
	"github.com/shuTwT/nex-api/internal/handler/ads"
	"github.com/shuTwT/nex-api/internal/handler/auth"
	"github.com/shuTwT/nex-api/internal/handler/catalog"
	"github.com/shuTwT/nex-api/internal/handler/cron"
	"github.com/shuTwT/nex-api/internal/handler/dashboard"
	"github.com/shuTwT/nex-api/internal/handler/gateway"
	"github.com/shuTwT/nex-api/internal/handler/marketplace"
	"github.com/shuTwT/nex-api/internal/handler/mcpgateway"
	"github.com/shuTwT/nex-api/internal/handler/membership"
	"github.com/shuTwT/nex-api/internal/handler/oauth"
	"github.com/shuTwT/nex-api/internal/handler/payment"
	"github.com/shuTwT/nex-api/internal/handler/schedule"
	"github.com/shuTwT/nex-api/internal/handler/settings"
	"github.com/shuTwT/nex-api/internal/handler/system"
	"github.com/shuTwT/nex-api/internal/handler/upload"
