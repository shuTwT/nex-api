...
func (_c *SystemSettingCreate) SetCategory(v string) *SystemSettingCreate {
	_c.mutation.SetCategory(v)
	return _c
}

// SetNillableCategory sets the "category" field if the given value is not nil.
func (_c *SystemSettingCreate) SetNillableCategory(v *string) *SystemSettingCreate {
	if v != nil {
		_c.SetCategory(*v)
	}
	return _c
...
func (_c *SystemSettingCreate) SetNillableID(v *string) *SystemSettingCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *SystemSettingCreate) check() error {
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "SystemSetting.createdAt"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`ent: missing required field "SystemSetting.updatedAt"`)}
	}
	return nil
}
