...
func (_c *SessionCreate) SetSessionToken(v string) *SessionCreate {
...
func (_c *SessionCreate) check() error {
	if _, ok := _c.mutation.SessionToken(); !ok {
		return &ValidationError{Name: "sessionToken", err: errors.New(`ent: missing required field "Session.sessionToken"`)}
	}
