...
func (_u *SessionUpdate) SetSessionToken(v string) *SessionUpdate {
	_u.mutation.SetSessionToken(v)
	return _u
}

// SetNillableSessionToken sets the "sessionToken" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableSessionToken(v *string) *SessionUpdate {
	if v != nil {
...
func (_u *SessionUpdate) SetExpires(v time.Time) *SessionUpdate {
	_u.mutation.SetExpires(v)
	return _u
}

// SetNillableExpires sets the "expires" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableExpires(v *time.Time) *SessionUpdate {
	if v != nil {
		_u.SetExpires(*v)
	}
	return _u
...
// SetSessionToken sets the "sessionToken" field.
func (_u *SessionUpdateOne) SetSessionToken(v string) *SessionUpdateOne {
	_u.mutation.SetSessionToken(v)
	return _u
}

// SetNillableSessionToken sets the "sessionToken" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableSessionToken(v *string) *SessionUpdateOne {
	if v != nil {
		_u.SetSessionToken(*v)
	}
	return _u
...
// SetExpires sets the "expires" field.
func (_u *SessionUpdateOne) SetExpires(v time.Time) *SessionUpdateOne {
	_u.mutation.SetExpires(v)
	return _u
}

// SetNillableExpires sets the "expires" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableExpires(v *time.Time) *SessionUpdateOne {
	if v != nil {
		_u.SetExpires(*v)
	}
	return _u
