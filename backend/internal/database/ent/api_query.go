...
type APIQuery struct {
	...
	withParameters   *ApiParameterQuery
	withResponses    *ApiResponseQuery
	withUsageRecords *ApiUsageQuery
...
func (_q *APIQuery) QueryCategory() *ApiCategoryQuery {
...
func (_q *APIQuery) QueryParameters() *ApiParameterQuery {
	query := (&ApiParameterClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *APIQuery) QueryResponses() *ApiResponseQuery {
	query := (&ApiResponseClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *APIQuery) QueryUsageRecords() *ApiUsageQuery {
...
func (_q *APIQuery) Clone() *APIQuery {
	...
	return &APIQuery{
		...
		withParameters:   _q.withParameters.Clone(),
...
func (_q *APIQuery) WithCategory(opts ...func(*ApiCategoryQuery)) *APIQuery {
	query := (&ApiCategoryClient{config: _q.config}).Query()
...
func (_q *APIQuery) WithParameters(opts ...func(*ApiParameterQuery)) *APIQuery {
	query := (&ApiParameterClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withParameters = query
	return _q
}
...
func (_q *APIQuery) WithResponses(opts ...func(*ApiResponseQuery)) *APIQuery {
	query := (&ApiResponseClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *APIQuery) WithUsageRecords(opts ...func(*ApiUsageQuery)) *APIQuery {
	query := (&ApiUsageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *APIQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Api, error) {
	...
	if query := _q.withCategory; query != nil {
		if err := _q.loadCategory(ctx, query, nodes, nil,
			func(n *Api, e *ApiCategory) { n.Edges.Category = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withParameters; query != nil {
		if err := _q.loadParameters(ctx, query, nodes,
			func(n *Api) { n.Edges.Parameters = []*ApiParameter{} },
			func(n *Api, e *ApiParameter) { n.Edges.Parameters = append(n.Edges.Parameters, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withResponses; query != nil {
		if err := _q.loadResponses(ctx, query, nodes,
			func(n *Api) { n.Edges.Responses = []*ApiResponse{} },
			func(n *Api, e *ApiResponse) { n.Edges.Responses = append(n.Edges.Responses, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withUsageRecords; query != nil {
		if err := _q.loadUsageRecords(ctx, query, nodes,
			func(n *Api) { n.Edges.UsageRecords = []*ApiUsage{} },
			func(n *Api, e *ApiUsage) { n.Edges.UsageRecords = append(n.Edges.UsageRecords, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *APIQuery) loadCategory(ctx context.Context, query *ApiCategoryQuery, nodes []*Api, init func(*Api), assign func(*Api, *ApiCategory)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Api)
	for i := range nodes {
...
func (_q *APIQuery) loadParameters(ctx context.Context, query *ApiParameterQuery, nodes []*Api, init func(*Api), assign func(*Api, *ApiParameter)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(apiparameter.FieldApiId)
	}
	query.Where(predicate.ApiParameter(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(api.ParametersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "apiId" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *APIQuery) loadResponses(ctx context.Context, query *ApiResponseQuery, nodes []*Api, init func(*Api), assign func(*Api, *ApiResponse)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Api)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(apiresponse.FieldApiId)
	}
	query.Where(predicate.ApiResponse(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(api.ResponsesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *APIQuery) loadUsageRecords(ctx context.Context, query *ApiUsageQuery, nodes []*Api, init func(*Api), assign func(*Api, *ApiUsage)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Api)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(apiusage.FieldApiId)
	}
	query.Where(predicate.ApiUsage(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(api.UsageRecordsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *APIQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(api.Table, api.Columns, sqlgraph.NewFieldSpec(api.FieldID, field.TypeString))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCategory != nil {
			_spec.Node.AddColumnOnce(api.FieldCategoryId)
		}
	}
