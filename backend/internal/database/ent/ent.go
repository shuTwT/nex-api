...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			advertisement.Table:     advertisement.ValidColumn,
			api.Table:               api.ValidColumn,
			apicategory.Table:       apicategory.ValidColumn,
			apiparameter.Table:      apiparameter.ValidColumn,
			apiresponse.Table:       apiresponse.ValidColumn,
			apitoken.Table:          apitoken.ValidColumn,
			apiusage.Table:          apiusage.ValidColumn,
			auditlog.Table:          auditlog.ValidColumn,
			mcpservice.Table:        mcpservice.ValidColumn,
