...
var envBindings = []envBinding{
	...
	{key: "payment.wechat.app_id", names: []string{"WECHAT_PAY_APP_ID"}},
	{key: "payment.wechat.mch_id", names: []string{"WECHAT_PAY_MCH_ID"}},
	{key: "payment.wechat.api_key", names: []string{"WECHAT_PAY_API_KEY"}},
	{key: "payment.wechat.private_key", names: []string{"WECHAT_PAY_PRIVATE_KEY"}},
	{key: "payment.wechat.public_key", names: []string{"WECHAT_PAY_PUBLIC_KEY"}},
	{key: "payment.wechat.payment_public_key", names: []string{"WECHAT_PAY_PAYMENT_PUBLIC_KEY"}},
	{key: "payment.wechat.public_key_id", names: []string{"WECHAT_PAY_PUBLIC_KEY_ID"}},
	{key: "payment.wechat.notify_url", names: []string{"WECHAT_PAY_NOTIFY_URL"}},
	{key: "payment.wechat.debug", names: []string{"WECHAT_PAY_DEBUG"}},
	{key: "payment.alipay.app_id", names: []string{"ALIPAY_APP_ID"}},
	{key: "payment.alipay.private_key", names: []string{"ALIPAY_PRIVATE_KEY"}},
	{key: "payment.alipay.public_key", names: []string{"ALIPAY_PUBLIC_KEY"}},
	{key: "payment.alipay.notify_url", names: []string{"ALIPAY_NOTIFY_URL"}},
	{key: "payment.alipay.return_url", names: []string{"ALIPAY_RETURN_URL"}},
	{key: "payment.alipay.sandbox", names: []string{"ALIPAY_SANDBOX"}},
	{key: "payment.mock.enabled", names: []string{"MOCK_PAYMENT_ENABLED"}},
	{key: "payment.mock.auto_success", names: []string{"MOCK_PAYMENT_AUTO_SUCCESS"}},
	{key: "payment.mock.delay", names: []string{"MOCK_PAYMENT_DELAY"}},
