...
func (h *Handler) createCategory(w http.ResponseWriter, r *http.Request) {
	...
	item, err := h.categories.Create(r.Context(), CategoryInput{Name: request.Name, Description: request.Description, Icon: request.Icon})
	if err != nil {
		writeCatalogError(w, r, err)
		return
	}
...
func (h *Handler) updateCategory(w http.ResponseWriter, r *http.Request) {
	...
	item, err := h.categories.Update(r.Context(), r.PathValue("id"), CategoryUpdateInput{Name: request.Name, Description: request.Description, Icon: request.Icon})
	if err != nil {
		writeCatalogError(w, r, err)
		return
	}
