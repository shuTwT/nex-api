...
func DefaultSystemSettings() SystemSettingsDefaultsResp {
	return SystemSettingsDefaultsResp{
		General:   []SystemSettingDefaultDTO{{"siteName", "API 网关", "general", "网站名称"}, {"siteLogo", "", "general", "网站 Logo"}, {"contactEmail", "support@example.com", "general", "联系邮箱"}},
		...
		OAuth:     SystemSettingDefaultGroupsDTO{Basic: []SystemSettingDefaultDTO{{"githubOAuthClientId", "", "oauth", "GitHub OAuth App Client ID"}, {"githubOAuthClientSecret", "", "oauth", "GitHub OAuth App Client Secret"}, {"oidcProvider", "", "oauth", "自定义 OIDC 提供商配置"}, {"oauthProviders", "[]", "oauth", "自定义 OAuth 提供商配置"}}},
	}
}
